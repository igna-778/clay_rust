...
#[repr(u32)]
pub enum ErrorType {
    TextMeasurementFunctionNotProvided = Clay_ErrorType_CLAY_ERROR_TYPE_TEXT_MEASUREMENT_FUNCTION_NOT_PROVIDED,
    ...
    TextMeasurementCapacityExceeded = Clay_ErrorType_CLAY_ERROR_TYPE_TEXT_MEASUREMENT_CAPACITY_EXCEEDED,
    DuplicateId = Clay_ErrorType_CLAY_ERROR_TYPE_DUPLICATE_ID,
    FloatingContainerParentNotFound = Clay_ErrorType_CLAY_ERROR_TYPE_FLOATING_CONTAINER_PARENT_NOT_FOUND,
