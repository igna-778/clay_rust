...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of Clay_Arena"][::core::mem::size_of::<Clay_Arena>() - 40usize];
    ["Alignment of Clay_Arena"][::core::mem::align_of::<Clay_Arena>() - 8usize];
    ["Offset of field: Clay_Arena::label"][::core::mem::offset_of!(Clay_Arena, label) - 0usize];
    ["Offset of field: Clay_Arena::nextAllocation"]
        [::core::mem::offset_of!(Clay_Arena, nextAllocation) - 16usize];
    ["Offset of field: Clay_Arena::capacity"]
        [::core::mem::offset_of!(Clay_Arena, capacity) - 24usize];
    ["Offset of field: Clay_Arena::memory"][::core::mem::offset_of!(Clay_Arena, memory) - 32usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Offset of field: Clay_SizingAxis__bindgen_ty_1::sizeMinMax"]
        [::core::mem::offset_of!(Clay_SizingAxis__bindgen_ty_1, sizeMinMax) - 0usize];
    ["Offset of field: Clay_SizingAxis__bindgen_ty_1::sizePercent"]
        [::core::mem::offset_of!(Clay_SizingAxis__bindgen_ty_1, sizePercent) - 0usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
...
const _: () = {
    ...
    ["Offset of field: Clay_RenderCommand::name"]
        [::core::mem::offset_of!(Clay_RenderCommand, name) - 48usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
